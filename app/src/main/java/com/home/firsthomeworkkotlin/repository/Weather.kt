...
fun getDefaultCity() = City("Санкт-Петербург", 59.9342802, 30.335098600000038)
...
fun getRussianCities() = listOf(
        Weather(City("Москва", 55.755826, 37.617299900000035), +6, +6),
        Weather(City("Санкт-Петербург", 59.9342802, 30.335098600000038), +5, +4),
        Weather(City("Новосибирск", 55.00835259999999, 82.93573270000002), -4, -6),
        Weather(City("Екатеринбург", 56.83892609999999, 60.60570250000001), +3, +3),
        Weather(City("Нижний Новгород", 56.2965039, 43.936059), +10, +9),
        Weather(City("Казань", 55.8304307, 49.06608060000008), +3, +4),
        Weather(City("Челябинск", 55.1644419, 61.4368432), +5, +6),
        Weather(City("Омск", 54.9884804, 73.32423610000001), +1, +1),
        Weather(City("Ростов-на-Дону", 47.2357137, 39.701505), +15, +16),
        Weather(City("Уфа", 54.7387621, 55.972055400000045), +5, +6),
        Weather(City("Дубна", 56.741627,37.172798), +0, +0),
        Weather(City("Кимры", 56.52, 37.21), +0, +0)
    )
